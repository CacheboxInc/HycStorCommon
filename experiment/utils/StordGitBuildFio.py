...
class StordBuild:
    ...
    def ExecutablePath(self):
        print("is program executable %s" % self._executable)
...
class Stord(Process):
    ...
    def Run(self):
        print ("stord args : %s" % self._args)
        print (self._build.ExecutablePath())
...
class Fio(Process):
    ...
    def Run(self):
        super(Fio, self).Run(self._program, self._args)

...
data1 = { "vmid": "%s" %VmId, "TargetID": "%s" %TargetID, "TargetName": "%s" %TargetName, "AeroClusterID":"%s" %AeroClusterID, 'VmUUID': 'hycvc43primaryiolan_Lin-cho-LINKED_CLONE-19'}
...
# POST call 8 to stord_svc aero_set_cleanup

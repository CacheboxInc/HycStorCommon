...
tgtd_args = '-f -e http://127.0.0.1:2379 -s tgt_svc -v v1.0 -p 9001 -D 127.0.0.1 -P 9876'.split()
stord_args = '-etcd_ip=http://127.0.0.1:2379 -stord_version=v1.0 -svc_label=stord_svc -ha_svc_port=9000 -v 1'.split()
fio_args = '--name=random --ioengine=libaio --iodepth=32  --norandommap --group_reporting --gtod_reduce=1 --stonewall --rw=randrw --bs=16384 --direct=1 --size=102400 --numjobs=1 --rwmixread=1 --randrepeat=0 --filename=/dev/sdb --runtime=99999m --time_based=1 --size=10g'.split()

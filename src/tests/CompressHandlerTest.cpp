...
class CompressHandlerTest : public ::testing::Test {
protected:
...
TEST_F(CompressHandlerTest, UncompressableAlignedOverWrite) {
...
TEST_F(CompressHandlerTest, CompressableUnAlignedOverWrite) {
...
TEST_F(CompressHandlerTest, UncompressableUnAlignedOverWrite) {
	/* write compressable data */
	auto write_a = NewRequestBuffer(vmdkp->BlockSize());
	::memset(write_a->Payload(), 'A', write_a->Size());
...
TEST_F(CompressHandlerTest, BulkCompressableAlignedWrite) {
